<?php
class post_authorbio extends WP_Widget {
function __construct() {
parent::__construct(
// IB base del widget
'post_authorbio', 
// Nombre público del widget en UI
__('Biografía del autor', 'post_authorbio_domain'), 
// Descricpción de Widget
array( 'description' => __( 'Muestra la biografía del autor de la entrada dentro de la página publicada' ), ) 
);
}
...
register_widget( 'post_authorbio' );
