	<footer id="colophon" class="site-footer container-fluid" role="contentinfo">
		...
		<div class="container-fluid">
			...
			<div class="site-info row">
				...
				<div class="col-xs-12 col-md-5">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-5 logo_footer">
							<img src="<?php echo get_bloginfo('template_directory')?>/images/logo.png" alt="<?php echo get_bloginfo('title')?>">
						</div>
				...
				<div class="col-xs-12 col-md-4 hidden-lg-down">
					<div class="row">
						<div class="col-xs-12">
				...
				<div class="col-xs-3 hidden-lg-down">
		...
		<div class="aviso_privacidad row">
			<div class="col-xs-12 copyright">
				© Media2Code | Todos los derechos reservados | Realizado con:  <i class="fa fa-heart" aria-hidden="true"></i> + <i class="fa fa-wordpress" aria-hidden="true"></i>
